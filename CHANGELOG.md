...
### Packages rebuilt (64-bit) for Version 2.1.2-64bit
...
### Removed for Version 2.1.0-64bit
...
### Removed for Version 2.0.2-64bit
...
### Changed for Version 2.0.1-64bit
...
### Removed for Version 2.0.1-64bit
...
*(Legacy releases by [tauqua](<https://g>ithub.com/tauqua) - see the [original repository](<https://g>ithub.com/tauqua/gog-galaxy-itch.io/releases/tag/v0.0.6) for historical changelog entries.)*